...
namespace LLoquendoEmulator
{
    public class MyCustomClass
    {
        ...
        /// Can be called from any reponse or web [LLoquendoEmulator.MyCustomClass.Test_InitWPFWindow]
        /// </summary>
        /// <returns></returns>
        ...
        /// Can be called from any reponse or web [LLoquendoEmulator.MyCustomClass.Test_ChangeTitleInMyCustomWindow("Hello World")]
        /// </summary>
        ...
        /// <summary>
        /// Closes the window
        /// Can be called from any reponse or web [LLoquendoEmulator.MyCustomClass.Test_FormClose]
        /// </summary>
        /// <returns></returns>
        ...
        private void InitializeWindow()
        {
            ...
            try
            {
                if (wpfTest.LINKSInitialized())
                {
                    ...
                    // Apply templates
                    // Note: This will not work on v2.6.2.3 or older            
                    wpfTest.test_comboBox_Voices.Template = comboBoxTemplate;
                    ...
                    wpfTest.test_textBox_Volume.Template = textBoxTemplate;
                    wpfTest.test_textBox_Rate.Template = textBoxTemplate;
